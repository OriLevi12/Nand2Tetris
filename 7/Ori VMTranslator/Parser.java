...
public class Parser{
    ...
    public int arg2(){
        if(commandType().equals("C_PUSH") || commandType().equals("C_POP")){
            return Integer.parseInt(currentCommand.split(" ")[2]); // Get the second argument (e.g., index)
        }
        throw new IllegalStateException("arg2() called on non C_PUSH or C_POP command");
    }
}